...
class AdvancedBDHInference:
    ...
    def predict(self, backstory_text: str, story_text: str, use_streaming: bool = False) -> Dict:
        ...
        # Tokenize story - Optimization: Tokenize once
        ...
        # torch.cuda.empty_cache() # Not needed for L2 (CPU only)
        ...
        # torch.cuda.empty_cache() # Not needed for L3 (CPU only)
        ...
        # torch.cuda.empty_cache() # Not needed for L4 (CPU only)
